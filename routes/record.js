...
import { get_record_response, insert_record_response, update_record_response, delete_record_response } from '../middleware/record.js';
...
router.get("/",[auth,get_record_check], get_record, get_record_response);
